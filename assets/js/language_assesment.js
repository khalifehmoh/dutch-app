...
const languageTestLogic = (setup, data) => {
  ...
  var renderMainDetails = function (state) {
    ...
    <div class="bar-con">
      <div class="bar-sub-con">
        ...
        <div id="bar1" class="barfiller" style="direction:rtl">
          <div class="tipWrap">
            <span class="tip"></span>
          </div>
  ...
  var renderQuestion = function (state) {
    ...
    pageQuestions.forEach((item, index) => {
      ...
      let singleQuestionDOM = `<form id="${formId}" class="js-q-box">` +
        ...
        "<h5><span class=\"js-q-number\" style=\"margin-right: 10px\">" + item.queNumber + ": </span></h5>" +
  ...
  var renderResult = function () {
    ...
    message = getResultMessage(totalMark);
    const getPercentage = () => {
      const factor = 100 / numberOfQuestions;
      return factor * totalMark
    }
    ...
    <span class="js-feedback-header">${setup.labels.yourResult}: ${totalMark}/${numberOfQuestions}</span>
    <div>
      ...
      <div class="container">
        ...
        <div class="panel-group" id="accordion-2">
            <div class="panel" style="background: transparent">
              ...
              bottom: -20px;
              z-index: 999;">
                <h4 class="panel-title" style="direction:rtl"> <a style="height: 45px;
  ...
  function handleSubmitAnswers() {
    $(".js-container").on("click", ".js-choice-submit-button", function (event) {
      ...
      if (state.lastRenderedQuestion !== state.totalQuestions + 10) {
        $([document.documentElement, document.body]).animate({
  ...
  function animateResult() {
    ...
    $(".btn-floating-wrong").hide();
    if (setup.layout.isNashoohAdviceOn) {
    ...
    setTimeout(() => {
      ...
      if (setup.layout.isTimeLimitOn) {
        $(".js-feedback-time-con").fadeIn(1000);
      }
    }, 500);
    ...
    setTimeout(() => {
      ...
      if (setup.layout.isWrongAnswersOn) {
        // $(".js-container").animate({
        //   height: '320px'
        // }, 2000, function () {
        //   $(".js-container").css("height", "auto");
        // });
        $(".btn-floating-wrong").fadeIn(2000);
      }
  ...
  function generateFeedbackSummary() {
    addFeedbackSummary(setup.feedbackText);
  }
  ...
  function get_data() {
    ...
    //     "question": {
    //       "id": "39",
    //       "title": "Bitte bringen Sie mir das kleine Frühstück mit einem __________ Tee.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "7",
    //       "title": "A: Ist das __________ Hemd?\nB: Nein, das ist __________ Hemd, das ist ein T-Shirt.",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "2",
    //       "title": "A: Was __________ du?\nB: Arabisch und ein bisschen Polnisch.",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "36",
    //       "title": "A: Nadia, hast du die neue Schreibtischlampe gesehen?\nB: Ja, sie steht __________ Tür. Stell sie doch bitte gleich __________ Tisch.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    //       {
    //         "id": "144",
    //         "title": "an die __ unter den ",
    //         "question_id": "36",
    //         "isRight": "0"
    //       },
    //       {
    //         "id": "141",
    //         "title": "hinter der __ auf den",
    //         "question_id": "36",
    //         "isRight": "1"
    //       },
    //       {
    //         "id": "142",
    //         "title": "hinter die __ auf dem",
    //         "question_id": "36",
    //         "isRight": "0"
    //       },
    //       {
    //         "id": "143",
    //         "title": "vor der __ auf die",
    //         "question_id": "36",
    //         "isRight": "0"
    //       }
    //     ]
    ...
    //     "question": {
    //       "id": "44",
    //       "title": "A: Entschuldigung, wo ist hier der nächste Kiosk?\nB: Da vorne ist gleich __________.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "45",
    //       "title": "Markus ärgert sich __________ seinen Sohn.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "41",
    //       "title": "Ab wann sind deine Eltern zu Besuch?",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "49",
    //       "title": "Schade,__________ es kein Frühstück mehr gibt.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "42",
    //       "title": "Ich habe __________ mit Freunden zum Essen verabredet.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "16",
    //       "title": "A: Ist die Wohnung teuer?\nB: Nein, sie ist sehr __________.",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "24",
    //       "title": "A: Entschuldigung! Ich suche das Hotel Sheraton.\nB: Fahren Sie zuerst __________ ↑ und biegen Sie dann nach __________ → ab.",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
    //       {
    //         "id": "94",
    //         "title": "zurück __ rechts",
    //         "question_id": "24",
    //         "isRight": "0"
    //       },
    //       {
    //         "id": "96",
    //         "title": "einen Kilometer __ rechts",
    //         "question_id": "24",
    //         "isRight": "0"
    //       },
    //       {
    //         "id": "93",
    //         "title": "geradeaus __ rechts",
    //         "question_id": "24",
    //         "isRight": "1"
    //       },
    //       {
    //         "id": "95",
    //         "title": "geradeaus __ links",
    //         "question_id": "24",
    //         "isRight": "0"
    //       }
    //     ]
    ...
    //     "question": {
    //       "id": "34",
    //       "title": "A: Warum willst du eigentlich in Deutschland arbeiten?\nB: __________ ich besser Deutsch lernen möchte.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "40",
    //       "title": "A: Jonas, es regnet und deine Hose hängt noch auf dem Balkon!\nB: Oh ja, ich hole sie gleich __________.",
    //       "level": "A2",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "22",
    //       "title": "A: Sie sind zu spät!?\nB: __________, mein Bus hatte Verspätung.",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
    ...
    //     "question": {
    //       "id": "17",
    //       "title": "Das Kinderzimmer ist 20 qm __________ .",
    //       "level": "A1",
    //       "mark": null
    //     },
    //     "answers": [
